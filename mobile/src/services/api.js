...
export const apiService = {
    ...
    deleteReview: (productId) => api.delete(`/api/v1/products/${productId}/reviews`),
    updateReview: (productId, reviewData) => api.put(`/api/v1/products/${productId}/reviews`, reviewData),
