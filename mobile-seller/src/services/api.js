...
export const apiService = {
    ...
    updateOrderStatus: (id, status, reason) => api.put(`/api/v1/orders/${id}/status`, { status, reason }),
    ...
    getSellerStats: () => api.get('/api/v1/seller/analytics'),
    submitKyc: (formData) => api.post('/api/v1/kyc/submit', formData, {
        headers: { 'Content-Type': 'multipart/form-data' },
    }),
